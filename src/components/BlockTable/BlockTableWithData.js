...
import { GET_BLOCKS, SUBSCRIBE_BLOCKS, SUBSCRIBE_TO_BLOCK_CHANGES } from "../../utils/queries";
...
export default function BlockTableWithData({ setBlocksCount }) {
  ...
  const updateBlocksTable = () => {

    subscribeToMore({
      document: SUBSCRIBE_TO_BLOCK_CHANGES,
       variables: { num: limit, offset: (currentPage - 1) * limit } ,
